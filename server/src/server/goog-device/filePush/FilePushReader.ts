...
import { CommandControlMessage, FilePushState } from '../../../common/controlMessage/CommandControlMessage';
import { FilePushResponseStatus } from '../../../common/googDevice/filePush/FilePushResponseStatus';
...
export class FilePushReader {
    ...
    private async createStream(chunk: Buffer): Promise<void> {
        ...
        this.readStream.push(chunk);
        this.pushTransfer = await AdbUtils.push(this.serial, this.readStream, this.fileName);
